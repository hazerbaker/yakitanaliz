...
public class EnumerationTypeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        EnumerationTypeDTO enumerationTypeDTO = (EnumerationTypeDTO) o;
        if (enumerationTypeDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), enumerationTypeDTO.getId());
    }
