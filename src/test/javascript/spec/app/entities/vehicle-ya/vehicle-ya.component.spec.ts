...
import { VehicleYaComponent } from 'app/entities/vehicle-ya/vehicle-ya.component';
...
describe('Component Tests', () => {
    describe('VehicleYa Management Component', () => {
        let comp: VehicleYaComponent;
        let fixture: ComponentFixture<VehicleYaComponent>;
        let service: VehicleYaService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [YakitanalizTestModule],
                declarations: [VehicleYaComponent],
                providers: [
                    {
                ...
                .overrideTemplate(VehicleYaComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(VehicleYaComponent);
